...
- **E2 PLDM model-family validation**: `paper1/results/external_validation/pldm_frozen_summary_v2.json` covers one independently trained four-task PLDM checkpoint family (36 rows). Balanced accuracy/AUPRC are `0.684/0.541`. Evaluation seeds 42/43/44 are conditional measurement replicates, not PLDM training seeds.
- **E3 fixed-rho blur/resize absolute and paired tests**: `paper1/results/external_validation/cross_stressor_fixed_rho_summary.json` retains all 16 pre-mapped absolute endpoints and all 32 base-to-endpoint pairs from LeWM and canonical PLDM. The absolute frozen endpoint slice remains conservative (`0.563/0.737`, recall `0.375`). Within LeWM, one untuned `delta_joint_score > 0` rule shared across all 24 blur/resize pairs reaches balanced accuracy/AUPRC `0.889/0.974`, precision/recall `0.882/1.000`, Spearman `0.864`, and signed agreement `0.917`; a 5,000-repeat bootstrap over 12 task-training-seed blocks gives Spearman 95% interval `[0.641,0.932]`. PLDM has one training family and supports analysis-interface portability, not shared absolute calibration.
...
| `paper1/results/external_validation/pldm_frozen_summary_v2.json` | E2 one-family PLDM frozen validation | `edf14d47a6b5e72097220e2b606f43a422e06ae9d832805cd2311f147e6b9387` |
| `paper1/results/external_validation/cross_stressor_fixed_rho_summary.json` | E3 absolute/paired blur-resize validation | `e4acc7a45b22f15e304d63d17ffaa27a6fec696ac6b10cd63056b173c9a78de8` |

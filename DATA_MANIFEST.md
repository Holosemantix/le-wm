...
- **E2 PLDM architecture portability**: `paper1/tables/table_pldm_architecture_portability.tex` summarizes one independently trained four-task PLDM checkpoint family (36 rows) under the current task-relative protocol. PLDM-local BA/precision/recall are `0.836/0.789/0.882`; the PLDM-anchored LeWM-source reference gives `0.807/0.778/0.824`. Evaluation seeds 42/43/44 are conditional measurement replicates, not PLDM training seeds, and raw thresholds are not assumed shared across families.
...
| `paper1/tables/table_pldm_architecture_portability.tex` | E2 one-family PLDM architecture-portability summary | `52186ae599deadc8f8756a14daca38b5a609b766142169ca123be19b31048df2` |
